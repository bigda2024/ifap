...
from utils import generate_json_file, send_json_file_to_kafka
import json
...
class Tracker:
    ...
    def draw_team_ball_control(self, frame, frame_num, team_ball_control):
        ...
        overlay = frame.copy()
        # cv2.rectangle(overlay, 1350, 850, (900, 970,),(255,255,255), cv2.FILLED)
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, player in player_dict.items():
                ...
                if player.get('has_ball', False):
                    ...
                    #file_name = 'C:/projects/football_analysis/output_files/' + str(formatted_datetime) +"_"+ str(track_id)+".json"

                    #generate_json_file(input_params, file_name)
                    send_json_file_to_kafka(input_params)
